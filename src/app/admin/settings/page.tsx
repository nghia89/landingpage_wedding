        ...
        <AdminLayout>
            <div className="p-6 lg:p-8 max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">Quản lý thông tin cơ bản của doanh nghiệp</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex justify-end">
                            <button
                                ...
                                className={clsx(
                                    'px-8 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center space-x-2',
                                    isSubmitting
