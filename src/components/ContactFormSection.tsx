                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <div className="pt-8 border-t border-pink-200/50">
                                ...
                                <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8">
                                    <a href="tel:0123456789" className="flex items-center space-x-3 text-rose-600 hover:text-rose-700 transition-colors duration-300 group">
                                    ...
                                    <a href="mailto:info@weddingdreams.vn" className="flex items-center space-x-3 text-rose-600 hover:text-rose-700 transition-colors duration-300 group">
                                        <div className="w-10 h-10 bg-rose-100 rounded-full flex items-center justify-center group-hover:bg-rose-200 transition-colors duration-300">
                                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <span className="font-semibold">info@weddingdreams.vn</span>
                                    </a>
                                </div>
                            </div>
                        </div>
